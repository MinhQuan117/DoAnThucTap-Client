...
public class MethodShippingAdapter extends RecyclerView.Adapter<MethodShippingAdapter.MethodShippingViewHolder> {
    ...
    @NonNull
    @Override
    public MethodShippingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MethodShippingViewHolder holder, int position) {
